...
(function() {
    ...
    const collectionLinks = Array.from(document.querySelectorAll('a[href*="/collection/"]')).filter(a => /\/collection\/\d+/.test(a.href));
        ...
        inspectButton.addEventListener('click', () => {
            ...
            iframe.onload = () => {
                try {
                    ...
                    const tourLinks = Array.from(iframeDoc.querySelectorAll('a[href*="/tour/"]')).filter(a => /\/tour\/\d+$/.test(a.href));
